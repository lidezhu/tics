...
void DataTypeLowCardinality::enumerateStreams(StreamCallback callback, SubstreamPath path) const
{
...
struct SerializeStateLowCardinality : public IDataType::SerializeBinaryBulkState
{
    ...
    explicit SerializeStateLowCardinality() {}
};
...
struct DeserializeStateLowCardinality : public IDataType::DeserializeBinaryBulkState
{
    ...
    explicit DeserializeStateLowCardinality() {}
};
...
{
    state = std::make_shared<SerializeStateLowCardinality>();
}
...
{
    state = std::make_shared<DeserializeStateLowCardinality>();
}
...
void DataTypeLowCardinality::serializeTextEscaped(const IColumn & , size_t , WriteBuffer & ) const
{
}

void DataTypeLowCardinality::deserializeTextEscaped(IColumn &, ReadBuffer &) const
{
}

void DataTypeLowCardinality::serializeTextQuoted(const IColumn &, size_t, WriteBuffer &) const
{
}

void DataTypeLowCardinality::deserializeTextQuoted(IColumn &, ReadBuffer &) const
{
}

void DataTypeLowCardinality::serializeTextCSV(const IColumn & , size_t , WriteBuffer & ) const
{
}

void DataTypeLowCardinality::deserializeTextCSV(IColumn & , ReadBuffer & , const char ) const
{
}

void DataTypeLowCardinality::serializeText(const IColumn & , size_t , WriteBuffer & ) const
{
}

void DataTypeLowCardinality::serializeTextJSON(const IColumn & , size_t , WriteBuffer & , const FormatSettingsJSON & ) const
{
}
void DataTypeLowCardinality::deserializeTextJSON(IColumn & , ReadBuffer & ) const
{
}

void DataTypeLowCardinality::serializeTextXML(const IColumn & , size_t , WriteBuffer & ) const
{
}
                                                                      ...
                                                                      const Creator & creator)
{
    ...
    // TODO: port more type to tiflash, e.g. Int
