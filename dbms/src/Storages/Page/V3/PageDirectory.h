...
public:
    ...
    bool updateRemotePage(const PageVersion & ver, const PageEntryV3 & entry);
...
public:
    ...
    PageEntries updateRemotePages(PageEntriesEdit && edit, const DB::PageStorageSnapshotPtr & snap_, const WriteLimiterPtr & write_limiter = nullptr);
